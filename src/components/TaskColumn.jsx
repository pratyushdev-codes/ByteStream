...
export function TaskColumn({ status, title, icon: Icon, tasks, onMoveTask, onDeleteTask }) {
  ...
  return (
    <div className="flex-1 min-w-[300px] backdrop-blur-lg bg-white/5 rounded-xl p-4 border border-[#ffffff19]">
      ...
      <div className="space-y-3">
        {columnTasks.map(task => (
          <div key={task.id} className="backdrop-blur-lg bg-white/5 p-3 rounded-lg shadow-lg border border-[#ffffff19]">
